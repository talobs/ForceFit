function [ obj ] = DLVO_expAtr_fit(obj, varargin )
%DLVO_EXPATR_FIT Summary of this function goes here
...
for i = 1:length(fields)
    ...
    f = fit(x, y, 'a*exp(-x/b)-c/x^2+d - e*exp(-x/f)', 'StartPoint', guess ,'Lower', lower, 'Upper', upper) ;
    ...
    obj.fp.b.aval_error = errors(5) - f.e ;
    obj.fp.lAtr.aval_error = errors(6) - f.f ;
